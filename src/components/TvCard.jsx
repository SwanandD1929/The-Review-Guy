      ...
      <div className="relative aspect-[2/3] w-full rounded-2xl overflow-hidden glass-card cursor-pointer">
        ...
        <div className="absolute top-3 left-3 flex flex-col gap-1.5 z-25">
          ...
          {communityRating && communityRating > 0 ? (
            <div className="flex items-center space-x-1 bg-black/75 backdrop-blur-md border border-white/20 px-2 py-0.5 rounded-full text-[10px] font-bold text-gray-300">
              <Star className="h-3 w-3 fill-gray-400 text-gray-400" />
              <span>COM {communityRating}</span>
            </div>
          ) : null}
        </div>
